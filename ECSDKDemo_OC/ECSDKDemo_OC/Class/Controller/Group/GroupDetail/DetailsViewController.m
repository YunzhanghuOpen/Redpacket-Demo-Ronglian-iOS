...
-(UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    if (indexPath.section == 0) {
        ...
        if (cell == nil) {
            ...
            frame.origin.x = cell.frame.size.width-switchs.frame.size.width-20.0f;
            frame.origin.y = (cell.frame.size.height-switchs.frame.size.height)*0.5;
            switchs.frame = frame;
