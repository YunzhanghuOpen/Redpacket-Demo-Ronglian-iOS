...
-(void)layoutSubviews{
    ...
    CGRect receipteBtnFrame = self.receipteBtn.frame;
    CGFloat receipteBtnW = _lengthLabel.frame.origin.x-receipteBtnFrame.size.width;
    receipteBtnFrame.origin.x = receipteBtnW<=0?0:receipteBtnW;
    self.receipteBtn.frame = receipteBtnFrame;
}
