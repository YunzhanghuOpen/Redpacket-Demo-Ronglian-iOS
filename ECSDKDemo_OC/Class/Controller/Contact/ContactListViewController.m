...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if ([addressbook isKindOfClass:[NSNull class]]) {
        ...
        if (cell == nil) {
            ...
            [cell.contentView addConstraints:[NSLayoutConstraint constraintsWithVisualFormat:@"|[textLabel]|" options:0 metrics:nil views:NSDictionaryOfVariableBindings(textLabel)]];
            [cell.contentView addConstraints:[NSLayoutConstraint constraintsWithVisualFormat:@"V:|-25-[textLabel(==20)]" options:0 metrics:nil views:NSDictionaryOfVariableBindings(textLabel)]];
        }
        return cell;
