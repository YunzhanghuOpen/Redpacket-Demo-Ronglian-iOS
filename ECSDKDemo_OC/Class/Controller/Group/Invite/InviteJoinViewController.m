...
-(void)prepareUI
{
    ...
    [self.view addConstraints:[NSLayoutConstraint constraintsWithVisualFormat:@"|[countLabel][inviteBtn(==160)]|" options:0 metrics:nil views:NSDictionaryOfVariableBindings(countLabel,inviteBtn)]];
    ...
    [self.view addConstraints:[NSLayoutConstraint constraintsWithVisualFormat:@"V:[inviteBtn(countLabel)]|" options:0 metrics:nil views:NSDictionaryOfVariableBindings(inviteBtn,countLabel)]];
}
