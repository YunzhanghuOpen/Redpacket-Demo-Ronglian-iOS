...
- (void)viewDidLoad {
    ...
    [_dataSourceDict setDictionary:@{
                                     ...
                                     @3:@[[CellBaseModel baseModelWithText:@"表情" detailText:nil img:[UIImage imageNamed:@"EmotionsEmojiHL@2x"] modelType:nil],[CellBaseModel baseModelWithText:@"钱包" detailText:nil img:img modelType:nil]]
                                     }];
