...
- (void)viewDidLoad
{
    ...
    numlabel.backgroundColor = [UIColor colorWithRed:1.00 green:0.62 blue:0.24 alpha:1.00];
    numlabel.textColor = [UIColor whiteColor];
    numlabel.font = [UIFont systemFontOfSize:13.0f];
    inlineNumLabel = numlabel;
    numlabel.text = @"";
    [self.view addSubview:numlabel];
    [self.view addConstraints:[NSLayoutConstraint constraintsWithVisualFormat:@"|[statusLabel][numlabel(==30)]|" options:0 metrics:nil views:NSDictionaryOfVariableBindings(statusLabel, numlabel)]];
    [self.view addConstraints:[NSLayoutConstraint constraintsWithVisualFormat:@"V:|[numlabel(==29)]" options:0 metrics:nil views:NSDictionaryOfVariableBindings(numlabel)]];
    
    self.membersArray = [NSMutableArray array];
    
    UITableView *tableView = [[UITableView alloc] initWithFrame:CGRectMake(0.0f, 29.0f, 320.0f, 10.0f) style:UITableViewStylePlain];
    ...
    micView.translatesAutoresizingMaskIntoConstraints = NO;
    [self.view addSubview:micView];
    [self.view addConstraints:[NSLayoutConstraint constraintsWithVisualFormat:@"|[micView]|" options:0 metrics:nil views:NSDictionaryOfVariableBindings(micView)]];
    [self.view addConstraint:[NSLayoutConstraint constraintWithItem:micView attribute:NSLayoutAttributeCenterX relatedBy:NSLayoutRelationEqual toItem:self.view attribute:NSLayoutAttributeCenterX multiplier:1 constant:0]];
    [self.view addConstraint:[NSLayoutConstraint constraintWithItem:micView attribute:NSLayoutAttributeCenterY relatedBy:NSLayoutRelationEqual toItem:self.view attribute:NSLayoutAttributeCenterY multiplier:1 constant:0]];
    ...
    [micView addConstraints:[NSLayoutConstraint constraintsWithVisualFormat:@"[label(==50)]-15-|" options:0 metrics:nil views:NSDictionaryOfVariableBindings(label)]];
    [micView addConstraints:[NSLayoutConstraint constraintsWithVisualFormat:@"V:|-[label(==30)]" options:0 metrics:nil views:NSDictionaryOfVariableBindings(label)]];
    ...
    [micView addConstraints:[NSLayoutConstraint constraintsWithVisualFormat:@"[micButton(==132)]" options:0 metrics:nil views:NSDictionaryOfVariableBindings(micButton)]];
    [micView addConstraints:[NSLayoutConstraint constraintsWithVisualFormat:@"V:[micButton(==132)]" options:0 metrics:nil views:NSDictionaryOfVariableBindings(micButton)]];
    [micView addConstraint:[NSLayoutConstraint constraintWithItem:micButton attribute:NSLayoutAttributeCenterX relatedBy:NSLayoutRelationEqual toItem:micView attribute:NSLayoutAttributeCenterX multiplier:1 constant:0]];
    [micView addConstraint:[NSLayoutConstraint constraintWithItem:micButton attribute:NSLayoutAttributeCenterY relatedBy:NSLayoutRelationEqual toItem:micView attribute:NSLayoutAttributeCenterY multiplier:1 constant:0]];
    
    UILabel *text_a = [[UILabel alloc] init];
    text_a.translatesAutoresizingMaskIntoConstraints = NO;
    ...
    [self.view addConstraints:[NSLayoutConstraint constraintsWithVisualFormat:@"|[text_a]|" options:0 metrics:nil views:NSDictionaryOfVariableBindings(text_a)]];
    
    UILabel *text_b = [[UILabel alloc] init];
    text_b.translatesAutoresizingMaskIntoConstraints = NO;
    ...
    [self.view addConstraints:[NSLayoutConstraint constraintsWithVisualFormat:@"|[text_b]|" options:0 metrics:nil views:NSDictionaryOfVariableBindings(text_b)]];
    
    UILabel *text_c = [[UILabel alloc] init];
    text_c.translatesAutoresizingMaskIntoConstraints = NO;
    ...
    [self.view addConstraints:[NSLayoutConstraint constraintsWithVisualFormat:@"|[text_c]|" options:0 metrics:nil views:NSDictionaryOfVariableBindings(text_c)]];
    
    UILabel *text_d = [[UILabel alloc] init];
    text_d.translatesAutoresizingMaskIntoConstraints = NO;
    ...
    [self.view addConstraints:[NSLayoutConstraint constraintsWithVisualFormat:@"|[text_d]|" options:0 metrics:nil views:NSDictionaryOfVariableBindings(text_d)]];
    
    [self.view addConstraints:[NSLayoutConstraint constraintsWithVisualFormat:@"V:|[statusLabel(==29)][tableView][micView(==145)]-[text_a(==25)][text_b(==20)][text_c(==20)][text_d(==20)]" options:0 metrics:nil views:NSDictionaryOfVariableBindings(statusLabel,tableView,micView,text_a,text_b,text_c,text_d)]];
