...
NSString * const kCallBg01pngVoip           = @"call_bg01";
NSString * const kCallHangUpButtonpng       = @"call_hang_up_button";
NSString * const kCallHangUpButtonOnpng     = @"call_hang_up_button_on";
...
@interface VoipCallController ()<KeyboardViewDelegate>
{
    BOOL isShowKeyboard;
    BOOL isKickOff;
}
...
- (void)prepareUI {
    ...
    _callerNameLabel.translatesAutoresizingMaskIntoConstraints = NO;
    [self.view addConstraints:[NSLayoutConstraint constraintsWithVisualFormat:@"|-labelmarginH-[_callerNameLabel]-labelmarginH-|" options:0 metrics:metrics views:NSDictionaryOfVariableBindings(_callerNameLabel)]];
    ...
    _callerNoLabel.translatesAutoresizingMaskIntoConstraints = NO;
    [self.view addConstraints:[NSLayoutConstraint constraintsWithVisualFormat:@"|-labelmarginH-[_callerNoLabel]-labelmarginH-|" options:0 metrics:metrics views:NSDictionaryOfVariableBindings(_callerNoLabel)]];
    ...
    _realTimeStatusLabel.translatesAutoresizingMaskIntoConstraints = NO;
    [self.view addConstraints:[NSLayoutConstraint constraintsWithVisualFormat:@"|[_realTimeStatusLabel]|" options:0 metrics:metrics views:NSDictionaryOfVariableBindings(_realTimeStatusLabel)]];
    [self.view addConstraints:[NSLayoutConstraint constraintsWithVisualFormat:@"V:|-topmargin-[_callerNameLabel(==labelV)]-labelV-[_callerNoLabel(==labelV)]-labelV-[_realTimeStatusLabel(==labelV)]" options:0 metrics:metrics views:NSDictionaryOfVariableBindings(_callerNameLabel,_callerNoLabel,_realTimeStatusLabel)]];
    ...
    [self.view addConstraints:[NSLayoutConstraint constraintsWithVisualFormat:@"|-hangUpButtonmarginH-[_hangUpButton]-hangUpButtonmarginH-|" options:0 metrics:metrics views:NSDictionaryOfVariableBindings(_hangUpButton)]];
    [self.view addConstraints:[NSLayoutConstraint constraintsWithVisualFormat:@"V:[_keyboardView(==keyboardViewH)]-5-[_functionAreaView(==50)]-hangUpButtonH-[_hangUpButton(==hangUpButtonH)]-20-|" options:0 metrics:metrics views:NSDictionaryOfVariableBindings(_keyboardView,_functionAreaView,_hangUpButton)]];
}
    ...
    if (voipCallType==2) {
        ...
        [[ECDevice sharedInstance].VoIPManager makeCallback:newCall completion:^(ECError *error, ECCallBackEntity *callBackEntity) {
            ...
            if (error.errorCode == ECErrorType_NoError) {
                ...
                [strongSelf.view bringSubviewToFront:strongSelf.realTimeStatusLabel];
            }
